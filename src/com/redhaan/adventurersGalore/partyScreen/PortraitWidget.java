...
public class PortraitWidget extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawImageTile(GameManager.adventurers.allAdventurers.get(PartyScreen.member).icon, offX + width / 2 - GameManager.GAMETILESIZE / 2, offY + height / 2, (int) temp, animationLine);		
