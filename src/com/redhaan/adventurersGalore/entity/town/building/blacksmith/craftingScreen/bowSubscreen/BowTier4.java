...
public class BowTier4 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawImageTile(longBow.icon, 35, 160, longBow.xTile, longBow.yTile);
		...
		renderer.drawImageTile(ivory.icon, 162, 167, ivory.xTile, ivory.yTile);
		...
		renderer.drawImageTile(spiritOfMischief.icon, 237, 167, spiritOfMischief.xTile, spiritOfMischief.yTile);
		...
		renderer.drawImageTile(elysianFlower.icon, 312, 167, elysianFlower.xTile, elysianFlower.yTile);
