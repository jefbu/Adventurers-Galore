...
public class StaffTier2 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(Weapon.icon, 35, 160, bo.xTile, bo.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 162, 167, oakwood.xTile, oakwood.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 167, ivory.xTile, ivory.yTile);
		...
		renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
			renderer.drawImageTile(Weapon.icon, 35, 205, baton.xTile, baton.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 162, 212, oakwood.xTile, oakwood.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 212, antlers.xTile, antlers.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 212, ivory.xTile, ivory.yTile);
