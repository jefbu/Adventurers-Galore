...
public class ArmourTier4 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 160, brigandine.xTile, brigandine.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 167, nobleSpirit.xTile, nobleSpirit.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 167, springBreeze.xTile, springBreeze.yTile);
		...
		renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 205, lamellar.xTile, lamellar.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 212, evilSpirit.xTile, evilSpirit.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 212, morningSunlight.xTile, morningSunlight.yTile);
		...
		renderer.drawRectOpaque(30, 245, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 250, hauberk.xTile, hauberk.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 257, vagrantSpirit.xTile, vagrantSpirit.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 257, pentupAnger.xTile, pentupAnger.yTile);
		...
		renderer.drawRectOpaque(30, 290, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 295, jousting.xTile, jousting.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 162, 302, silver.xTile, silver.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 302, nobleSpirit.xTile, nobleSpirit.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 302, gloriousMoment.xTile, gloriousMoment.yTile);
