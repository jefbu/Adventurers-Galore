...
public class StaffTier4 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(Weapon.icon, 35, 160, waddy.xTile, waddy.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 162, 167, antlers.xTile, antlers.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 167, vagrantSpirit.xTile, vagrantSpirit.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 167, rationalThought.xTile, rationalThought.yTile);
