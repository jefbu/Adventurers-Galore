...
public class ArmourTier2 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 160, quilt.xTile, quilt.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 167, bone.xTile, bone.yTile);
		...
		renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 205, boiledLeather.xTile, boiledLeather.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 212, coral.xTile, coral.yTile);
		...
		renderer.drawRectOpaque(30, 245, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 250, riveted.xTile, riveted.yTile);
		...
		renderer.drawRectOpaque(30, 290, 570, 40, 0xff181205);
			renderer.drawImageTile(Armour.icon, 35, 295, plate.xTile, plate.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 302, antlers.xTile, antlers.yTile);
