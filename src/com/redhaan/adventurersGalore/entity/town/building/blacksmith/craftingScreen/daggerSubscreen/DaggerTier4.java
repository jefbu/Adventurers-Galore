...
public class DaggerTier4 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(katar.icon, 35, 160, katar.xTile, katar.yTile);
			...
			renderer.drawImageTile(evilSpirit.icon, 237, 167, evilSpirit.xTile, evilSpirit.yTile);
			...
			renderer.drawImageTile(luckyClover.icon, 312, 167, luckyClover.xTile, luckyClover.yTile);
