...
public class BowTier2 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawImageTile(compositeBow.icon, 35, 160, compositeBow.xTile, compositeBow.yTile);
	...
	renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
		renderer.drawImageTile(handBow.icon, 35, 205, handBow.xTile, handBow.yTile);
		...
		renderer.drawImageTile(oakWood.icon, 312, 212, oakWood.xTile, oakWood.yTile);
