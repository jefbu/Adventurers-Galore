...
public class DaggerTier3 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(Weapon.icon, 35, 160, machete.xTile, machete.yTile);
		...
		renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
			renderer.drawImageTile(Weapon.icon, 35, 205, cinqueada.xTile, cinqueada.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 237, 212, fang.xTile, fang.yTile);
