...
public class SpearTier2 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawImageTile(Weapon.icon, 35, 160, lance.xTile, lance.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 167, claw.xTile, claw.yTile);
	...
	renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 205, pike.xTile, pike.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 237, 212, oakWood.xTile, oakWood.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 212, claw.xTile, claw.yTile);
