...
public class SpearTier4 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(naginata.icon, 35, 160, naginata.xTile, naginata.yTile);
			...
			renderer.drawImageTile(coral.icon, 162, 167, coral.xTile, coral.yTile);
			...
			renderer.drawImageTile(wanderlust.icon, 312, 167, wanderlust.xTile, wanderlust.yTile);
