...
public class Tier4 extends GameObject {
	...
	renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 160, silverSword.xTile, silverSword.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 162, 167, silver.xTile, silver.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 167, liquidInnocence.xTile, liquidInnocence.yTile);
	...
	renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 205, epee.xTile, epee.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 162, 212, coral.xTile, coral.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 237, 212, heartSpirit.xTile, heartSpirit.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 212, stolenMoonlight.xTile, stolenMoonlight.yTile);
	...
	renderer.drawRectOpaque(30, 245, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 250, falchion.xTile, falchion.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 162, 257, gold.xTile, gold.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 237, 257, spiritOfMischief.xTile, spiritOfMischief.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 257, reforgedPlough.xTile, reforgedPlough.yTile);
