...
public class ArmourTier3 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(gambeson.icon, 35, 160, gambeson.xTile, gambeson.yTile);
			...
			renderer.drawImageTile(heartSpirit.icon, 312, 167, heartSpirit.xTile, heartSpirit.yTile);
		...
		renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
			renderer.drawImageTile(reinforcedLeather.icon, 35, 205, reinforcedLeather.xTile, reinforcedLeather.yTile);
			...
			renderer.drawImageTile(violentSpirit.icon, 312, 212, violentSpirit.xTile, violentSpirit.yTile);
		...
		renderer.drawRectOpaque(30, 245, 570, 40, 0xff181205);
			renderer.drawImageTile(scale.icon, 35, 250, scale.xTile, scale.yTile);
			...
			renderer.drawImageTile(spiritOfMischief.icon, 312, 257, spiritOfMischief.xTile, spiritOfMischief.yTile);
		...
		renderer.drawRectOpaque(30, 290, 570, 40, 0xff181205);
			renderer.drawImageTile(gothic.icon, 35, 295, gothic.xTile, gothic.yTile);
			...
			renderer.drawImageTile(heartSpirit.icon, 312, 302, heartSpirit.xTile, heartSpirit.yTile);
