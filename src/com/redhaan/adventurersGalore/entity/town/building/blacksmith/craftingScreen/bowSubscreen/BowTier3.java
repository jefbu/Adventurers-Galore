...
public class BowTier3 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawImageTile(Weapon.icon, 35, 160, recurveBow.xTile, recurveBow.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 167, vagrantSpirit.xTile, vagrantSpirit.yTile);
