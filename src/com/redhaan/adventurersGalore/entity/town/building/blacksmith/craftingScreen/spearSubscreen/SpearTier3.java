...
public class SpearTier3 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawImageTile(Weapon.icon, 35, 160, yari.xTile, yari.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 237, 167, silver.xTile, silver.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 167, evilSpirit.xTile, evilSpirit.yTile);
	...
	renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 205, trident.xTile, trident.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 212, heartSpirit.xTile, heartSpirit.yTile);
