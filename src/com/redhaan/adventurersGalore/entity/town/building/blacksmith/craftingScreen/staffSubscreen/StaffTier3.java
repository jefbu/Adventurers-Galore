...
public class StaffTier3 extends GameObject {
	...
	public void render(GameContainer gameContainer, Renderer renderer) {
		...
		renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
			renderer.drawImageTile(Weapon.icon, 35, 160, cudgel.xTile, cudgel.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 162, 167, bone.xTile, bone.yTile);
			...
			renderer.drawImageTile(CraftItems.icon, 312, 167, spiritOfMischief.xTile, spiritOfMischief.yTile);
