...
public class Tier2 extends GameObject {
	...
	renderer.drawRectOpaque(30, 155, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 160, bastardSword.xTile, bastardSword.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 237, 167, claw.xTile, claw.yTile);
	...
	renderer.drawRectOpaque(30, 200, 570, 40, 0xff181205);
		renderer.drawImageTile(Weapon.icon, 35, 205, sabre.xTile, sabre.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 237, 212, claw.xTile, claw.yTile);
		...
		renderer.drawImageTile(CraftItems.icon, 312, 212, wing.xTile, wing.yTile);
